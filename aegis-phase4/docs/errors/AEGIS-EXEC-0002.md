# AEGIS-EXEC-0002 — GraphResult.trend_id != InferenceResult.trend_id.

**Symbolic name:** `EXEC_COMPOSER_TREND_ID_MISMATCH`
...
1. Search the structlog output for `error_code=AEGIS-EXEC-0002`.
