# AEGIS-EXEC-0010 — Expected margin below floor; alert blocked.

**Symbolic name:** `EXEC_RISK_MARGIN_BELOW_FLOOR`
...
1. Search the structlog output for `error_code=AEGIS-EXEC-0010`.
