# AEGIS-EXEC-0001 — Composer received neither GraphResult nor InferenceResult.

**Symbolic name:** `EXEC_COMPOSER_BOTH_INPUTS_MISSING`
...
1. Search the structlog output for `error_code=AEGIS-EXEC-0001`.
