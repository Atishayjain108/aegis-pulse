# AEGIS-EXEC-0030 — Notifier channel exceeded per-call timeout budget.

**Symbolic name:** `EXEC_NOTIFIER_TIMEOUT`
...
1. Search the structlog output for `error_code=AEGIS-EXEC-0030`.
