# AEGIS-EXEC-0031 — Notifier received non-2xx HTTP response.

**Symbolic name:** `EXEC_NOTIFIER_HTTP_ERROR`
...
1. Search the structlog output for `error_code=AEGIS-EXEC-0031`.
