# AEGIS-EXEC-0012 — Overall confidence below floor; alert blocked.

**Symbolic name:** `EXEC_RISK_CONFIDENCE_TOO_LOW`
...
1. Search the structlog output for `error_code=AEGIS-EXEC-0012`.
