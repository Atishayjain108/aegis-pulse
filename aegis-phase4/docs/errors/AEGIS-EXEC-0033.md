# AEGIS-EXEC-0033 — Webhook notifier requires HMAC key; channel disabled.

**Symbolic name:** `EXEC_NOTIFIER_HMAC_REQUIRED`
...
1. Search the structlog output for `error_code=AEGIS-EXEC-0033`.
