# AEGIS-EXEC-0021 — Redis unreachable; kill-switch defaults to TRIPPED (fail-closed).

**Symbolic name:** `EXEC_KILLSWITCH_BACKEND_UNAVAILABLE`
...
1. Search the structlog output for `error_code=AEGIS-EXEC-0021`.
